...
$query = 'select a.portfolio_id AS "PID", b.description AS "Description", b.risk_category as "Risk Category",  order_type AS "Order Type", order_date AS "Order Date", symbol AS "Symbol", shares AS "Shares", a.execute_time as "Executed Time" from order_history_queue a, liveportfolio_account b where a.portfolio_id = b.portfolio_id and b.status = "A" order by PID';
