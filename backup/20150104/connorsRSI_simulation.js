...
//				enableMouseTracking: false
	...
	function startSimulationFast() {
		...
		{
			type: "GET",
			url: "scripts/connorsRSI_strat.php?action=simulate_range_trade&start_date="+startingDate+"&end_date="+endingDate+"&enterCRSI="+enterCRSI+"&enterRange="+enterRange+"&enterLimit="+enterLimit+"&exitCRSI="+exitCRSI,
			data: "",
			dataType: "json",
			success: function(portfolioReturn)
			{
