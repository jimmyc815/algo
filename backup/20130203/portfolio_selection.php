...
//		echo json_encode($json_result);
		...
		populateDailyBuyList ($date, $movingAvg, $symbol);
...
function getBreakoutStock5 ($today_date, $movingAvg, $rankAndWeightArray) {
...
function populateDailyBuyList ($today_date, $movingAvg, $rankAndWeightArray) {
			//clear daily buy list
			$query = "delete from turtle_daily_buy_list";
			$result = queryMysql($query);
			// reset identity column
			$query = "alter table turtle_daily_buy_list auto_increment = 1";
			$result = queryMysql($query);
			
			$query = "insert into turtle_daily_buy_list (trade_date, symbol, buy_price) ";
			$query .= "select a.trade_date, a.symbol, a.".$movingAvg;
			$query .= " from price_history a, stock_list b ";
			$query .= "where a.trade_date = '".$today_date."'";
			$query .= "and a.symbol = b.symbol ";
			$query .= " and a.50_MA > a.200_MA";
