...
function historical_stock_return($symbol, $start_date, $end_date) {
		...
		$query  = "select adj_close from quotes_memory where symbol = '".$symbol."' and trade_date = ";
		...
		$query  = "select trade_date, adj_close, ((adj_close - (".$startPrice." * (adj_close/close)))/(".$startPrice." * (adj_close/close)) * 100), 50_MA, 200_MA, 55_DAY_HIGH, 20_DAY_LOW, 20_DAY_HIGH ";
