...
//		$breakOutList = getBreakoutStock4 ($date, "55_DAY_HIGH", $testArray);
		...
		$simResult = simulate_range_trade($portfolioID, $start_date, $end_date, $enterCRSI, $enterRange, $enterLimit, $exitCRSI, $commission, $max_risk, $risk_factor, $stop_loss_multiplier, $orderBy, $skipFactor, $original_investment );	
...
function simulate_range_trade($portfolioID, $start_date, $end_date, $enterCRSI, $enterRange, $enterLimit, $exitCRSI, $commission, $max_risk, $risk_factor, $stop_loss_multiplier, $orderBy, $skipFactor, $cash ) {
		...
		if ($cash) {$original_investment = $cash;}
