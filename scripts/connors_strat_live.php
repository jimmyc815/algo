...
if($_GET){
	if($_GET['action'] == 'register_new_live_account'){ 
			...
			$portfolioID = register_new_live_account($description, $risk_category, $start_date, $enterCRSI, $enterRange, $enterLimit, $exitCRSI, $orderBy, $max_risk, $risk_factor, $stop_loss_multiplier, $original_investment);
...
function live_crsi_buy ($date, $portfolioID, $enterCRSI, $enterRange, $enterLimit, $orderBy, $risk_factor, $stop_loss_multiplier, $max_risk) {
		global $max_num_holdings;
		#global $max_risk;
		#global $risk_factor;
		#global $stop_loss_multiplier;
...
function register_new_live_account($description, $risk_category, $start_date, $enter_crsi, $enter_range, $pct_limit_below, $exit_crsi, $order_by, $max_risk, $risk_factor, $risk_sd, $starting_capital){
	global $liveportfolio_account;
