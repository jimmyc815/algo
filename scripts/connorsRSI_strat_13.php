...
echo "start date: $start_date end date: $end_date enter crsi: $enterCRSI enter range: $enterRange enter limit $enterLimit exit crsi $exitCRSI commision $commission max risk $max_risk risk factor $risk_factor stop loss: $stop_loss_multiplier order by $orderBy ", PHP_EOL;
