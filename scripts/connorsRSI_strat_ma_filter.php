...
#		$query .= " and a.low  < c.buy_price";
		...
		$query .= " and a.low * (a.adj_close / a.close)  > a.200_MA ";
...
#print "$query <br />";
			...
			## remove stock lower than 200 ma
			$query  = "delete from $dailyBuyList where portfolio_id = $portfolioID ";
			#$query .= "and exists (select 1 from price_history where trade_date = '$today_date' and crsi > 50 and price_history.symbol = $dailyBuyList.symbol  )";
			$query .= "and exists (select 1 from quotes_memory where trade_date = '$today_date' and low * (adj_close / close) < 200_MA and quotes_memory.symbol = $dailyBuyList.symbol  )";
