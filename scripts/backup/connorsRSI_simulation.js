...
//portfolio_id | symbol | last_price | shares | cost_basis | overall_return | stop_loss | stop_buy | risk    | risk_pct |
	...
	function display_daily_buy_list() {
			var textInput = "select symbol, trade_date, buy_price, rank from crsi_daily_buy_list where portfolio_id = 1 order by rank asc";
...
//				$("#minReturn").val(data.min);
		...
		var processTimePerTradeDay = 200;
		var numDays;
		var refreshCount = 1;
