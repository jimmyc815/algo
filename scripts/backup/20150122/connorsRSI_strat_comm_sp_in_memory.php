...
function crsi_sell ($date, $portfolioID, $tranHistory, $exitCRSI, $stopLoss, $next_date) {
		...
		$query .= "from turtle_portfolio a, quotes_memory b ";
		...
		if ($stopLoss) {
			$query .= "union
						...
						from turtle_portfolio a, quotes_memory b
...
*/
		...
		$delete_query = "delete from turtle_portfolio where portfolio_id = ".$portfolioID." and symbol in (NULL ";
		...
		$update_portfolio_query = "update turtle_portfolio set shares = shares + ".$total_sale." where portfolio_id = ".$portfolioID." and symbol ='CASH'";
...
function get_historical_turtle_portfolio_value($trade_date, $portfolioID) {
	...
	$my_sql  = "select sum(a.shares * b.close) from turtle_portfolio a, quotes_memory b where a.portfolio_id = ".$portfolioID." and a.symbol = b.symbol and a.symbol != 'CASH' and ";
	$my_sql .= "b.trade_date = '".$trade_date."' ";
	$my_sql .= "union ";
	$my_sql .= "select shares from turtle_portfolio where symbol = 'CASH' and portfolio_id = ".$portfolioID;

	## use adj_close
	$my_sql  = "select sum(a.shares * b.adj_close) from turtle_portfolio a, quotes_memory b where a.portfolio_id = ".$portfolioID." and a.symbol = b.symbol and a.symbol != 'CASH' and ";
	$my_sql .= "b.trade_date = '".$trade_date."' ";
	$my_sql .= "union ";
	$my_sql .= "select shares from turtle_portfolio where symbol = 'CASH' and portfolio_id = ".$portfolioID;
