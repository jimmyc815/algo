...
echo "$query ", PHP_EOL;
		...
		while ($data = mysql_fetch_row($result)) {
			...
			if ($data[0] == "SELL") {
				...
				echo "SELL: ", $sell_list[$sell_count]['symbol'], " Shares: ", $sell_list[$sell_count]['shares'] , PHP_EOL;
				...
				echo "BUY: ", $buy_list[$buy_count]['symbol'], PHP_EOL;
...
echo "insert tran hist: ", $my_sql , PHP_EOL;
if ($showOutput) {
	print "$my_sql <br />";	
}
					#try {
...
#echo "after crsi buy ", PHP_EOL;			
			...
			crsi_buy_and_sell($trade_date, $breakOutSignal, $ADX_filter, $breakOutOrderBy, $portfolioID, $dailyBuyList, $enterCRSI, $exitCRSI, $enterRange, $enterLimit, $tranHistory, $orderBy, $next_trade_date, $skipFactor, $stop_loss_multiplier, $max_risk, $risk_factor);
