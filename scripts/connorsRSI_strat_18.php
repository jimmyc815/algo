...
function crsi_sell ($date, $portfolioID, $tranHistory, $exitCRSI, $stopLoss, $next_date) {
		...
		$query  = "select a.symbol, b.close, b.low, b.daily_change, b.pct_change, b.ATR, b.55_DAY_HIGH, b.20_DAY_HIGH, b.20_DAY_LOW, b.10_DAY_LOW, b.50_MA, b.200_MA, stop_loss, stop_buy, shares, risk, risk_pct, b.high, b.vsSpyRank, b.crsi, c.open * (c.adj_close / c.close) as next_open ";
		$query .= "from $portfolio_table a, quotes_memory b , quotes_memory c ";
		$query .= "where a.symbol = b.symbol ";
		$query .= "and b.symbol = c.symbol ";
		$query .= "and b.trade_date_id = c.trade_date_id - 1 ";
...
#echo "after crsi buy ", PHP_EOL;			
		...
		echo "before inserting portfoli perform ", PHP_EOL;
		...
		echo "after inserting portfolioi perform ", PHP_EOL;
