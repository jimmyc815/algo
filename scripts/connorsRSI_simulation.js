...
*/
	...
	function display_portfolio2() {
			var textInput = "select symbol, last_price, shares, cost_basis, stop_loss, stop_buy, risk, risk_pct from portfolio1 where portfolio_id = 1 order by risk desc";
...
//portfolio_id | symbol | last_price | shares | cost_basis | overall_return | stop_loss | stop_buy | risk    | risk_pct |
	...
	function display_transaction() {
			var textInput = "select symbol, trade_type, trade_date, shares, round(price, 2) as price, vsSpyRank from turtle_portfolio_transaction1 where portfolio_id = 1 order by trade_date desc limit 100";
