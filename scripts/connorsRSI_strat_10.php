...
*/
#print "date: $date	portfolio value: $portfolio_value	cash: $cash	risk value: $risk_value	max risk: $max_risk risk sd: $risk_sd current N: $current_N	symbol: ".$breakOutStockArray[$x]['symbol']."\n";
...
#print "date: $date max risk: $max_risk stop loss mul: $stop_loss_multiplier risk factor: $risk_factor current risk: $current_risk\n";
